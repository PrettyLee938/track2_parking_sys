...
export const charge = { ...idParams, body: { type: 'object', required: ['parkingCost', 'chargingCost'], properties: { parkingCost: { type: 'number', minimum: 0 }, chargingCost: { type: 'number', minimum: 0 } }, additionalProperties: false } };
