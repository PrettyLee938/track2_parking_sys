...
export function registerEquipmentRoutes(app: FastifyInstance, auth: AuthService, equipment: EquipmentService) {
  ...
  app.post('/api/v1/equipment/:id/repair', async (request, reply) => {
